...
def test_recovery_transitions():
    ...
    assert can_transition(JourneyState.AUTHENTICATE, JourneyState.FIELD_CONFIRMATION)
    assert can_transition(JourneyState.FIELD_CONFIRMATION, JourneyState.AUTHENTICATE)
    assert can_transition(JourneyState.FIELD_CONFIRMATION, JourneyState.CONSENT)
